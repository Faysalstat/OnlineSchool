                    ...
                    <div class="container" style="width:70%;margin:auto">
                        ...
                        <form action="${base}/dashboard/updatecourse"  modelAttribute="course" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="courseCode" value="${course.courseCode}" placeholder="Course Code">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="courseLevel" >
                                    <option>${course.courseLevel}</option>
                                    <option>Basic</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="duration" value="${course.duration}" placeholder="ex: 10 hour">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="lecturesCount" value="${course.lecturesCount}" >
                            </div>
                            <div class="form-group">
                                <label>Number of Quizzes</label>
                                <input type="number" class="form-control" name="quizCount" value="${course.quizCount}">
                            </div>
                            <div class="form-group">
                                <label>Number of Students Capacity</label>
                                <input type="number" class="form-control" name="studentCapacity" value="${course.studentCapacity}">
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                           ...
                           <div style="width:60%;margin:100px auto;border:1px solid black">
                            ...
                            <div class="form-group">
                                <label>Summery</label>
                                <textarea class="form-control" rows="5" name="courseSummary" >${course.courseSummary}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Requirements</label>
                                <textarea class="form-control" rows="5" name="requirements" >${course.requirements}</textarea>
                            </div>
                            <div class="form-group">
